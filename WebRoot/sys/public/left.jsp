	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/sys/user_list.action">用户管理</a>
				</li>
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/sys/dinnertable_list.action">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/sys/foodtype_list.action">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/sys/food_list.action">菜品管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/sys/order_list.action">餐厅订单</a>
				</li>
            </ul>
        </li>
    </ul>
