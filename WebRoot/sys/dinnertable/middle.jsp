...
<html>
  ...
  <body style="background-image:url(${basePath}images/6-1003291913490.jpg);background-position:center; background-repeat:repeat-y">
	...
	<form action="${basePath }sys/dinnertable_order.action" method="post" style="margin-top: 150px;margin-left: 200px">
		<table>
			<tr>
				...
				<td><input type="hidden" name="dinnerTable.id" value="${requestScope.tableid }"/></td>
			</tr>
		</table>
